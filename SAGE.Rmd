...
Gender -> Man, Woman, Other, Prefer not to disclose
Raceethnicity -> Systemically Dominant [SD] (white, asian), Systemically Non Dominant [SND], Mixed, Prefer not to disclose
Education -> 1st gen, not 1st gen, Prefer not to disclose
...
From this, 7 - 9 factors are near equivalent with n=7 to have a lower AIC and n=9 to have a lower Chisq.
...
ggplot(df.lr, aes(x=Gender_group, y=f1, fill=Gender_group)) + geom_boxplot()
```
